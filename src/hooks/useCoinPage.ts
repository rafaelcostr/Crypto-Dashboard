...
import { fetchCoinDetail, fetchCoinTickers, type CoinDetailData } from '../api/coingecko'
import { fetchCryptoNewsForCoin } from '../api/news'
import { useMarketsContext } from '../context/MarketsContext'
import { getLivePrice } from '../api/binance'
import type { LivePrice } from '../types'
import type { CoinTicker, CryptoNews } from '../types'
